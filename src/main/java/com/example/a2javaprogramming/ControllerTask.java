...
public class ControllerTask {
    ...
    void onSaveTask(ActionEvent event) {
        if (!(taskNName.getText().isEmpty() && taskStatus.getSelectionModel().getSelectedItem().toString().isEmpty())){
            Connection conn = getConnection();
    ...
    void onCreateTask(ActionEvent event) {
        ...
        if (!(taskNameForm.getText().isEmpty() && taskStatusForm.getSelectionModel().getSelectedItem().toString().isEmpty())){
            try{
